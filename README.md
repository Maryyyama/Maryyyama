...
<div align="center">
  ...
  **Студентка специальности «Разработчик веб и мультимедийных приложений» | Frontend-разработчик | UI/UX enthusiast**
...
| :--- | :--- | :--- | :--- |
| **LinguaLab** | Сайт для изучения иностранных языков. Есть недоработки, но основа готова | HTML, CSS, JS, Node.js, MongoDB Compass | ✅ Готов (требует доработки) |
| 🔜 To-Do лист | Приложение для заметок и задач | React + CSS | В процессе |
